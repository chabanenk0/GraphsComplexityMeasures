...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% The output are I) the entropy Sigma_o of undirected networks with the
...
% The vector W(d) that modulates the probability that a node i is 
% connected with a node j at distance d from i 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [Sigma_0,Sigma_d,W,z,kk]=Entropy_distance(pp,dd,Nd,l);
precision=10^(-2);
loops=1000;
