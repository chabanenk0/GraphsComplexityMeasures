...
[deg,fffff1,fffff2]=degrees(edgeL2adj(el));
...
while rew<k
    ...
    [ffffff4,inds1] = ismember([edge1(2),edge1(1),1],el,'rows');
    el(inds1,:)=[nodes(Y(4)),nodes(Y(1)),1];
            
    [ffffff5,inds2] = ismember([edge2(2),edge2(1),1],el,'rows');
